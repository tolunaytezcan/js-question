...
describe('move', () => {
  ...
  it('throws error if given source file not found', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '33', '1')).toThrow('Source is not a file');
  });

  it('throws error if given destination folder not found', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '2', '11')).toThrow('Destination is not a folder');
  });
  ...
  it('throws error if given source already in destination folder', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
      ...
      { id: '6', name: 'Folder 2', files: [{ id: '4', name: 'File 3' }] },
    ];

    expect(() => move(list, '3', '1')).toThrow('The file is already in this folder');
  });
});
